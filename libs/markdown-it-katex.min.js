  ...
  for (let e = l.length - 1; e >= 0; e--) {
    ...
    for (const e of i.matchAll(r)) {
      ...
      r && c.push({ ...s, type: "html_block", map: null, content: r }),
        ...
        i && c.push({ ...s, type: "html_block", map: null, content: i });
    }
...
function default_1(e, t) {
  ...
  e.inline.ruler.after("escape", "math_inline", inlineMath),
    ...
    n &&
      e.inline.ruler.before("text", "math_inline_bare_block", inlineBareBlock),
    e.block.ruler.after(
      "blockquote",
      "math_block",
      (e, t, r, l) =>
  ...
  const o = (e) => {
      try {
        return `<p class="katex-block">${katex_1.default.renderToString(e, {
          ...t,
          displayMode: !0,
        })}</p>`;
      } catch (n) {
  ...
  if (
    ((e.renderer.rules.math_inline = (e, n) =>
      ((e) => {
        const n = /\\begin\{(align|equation|gather|cd|alignat)\}/gi.test(e);
        try {
          return katex_1.default.renderToString(e, { ...t, displayMode: n });
        } catch (n) {
          return (
            t?.throwOnError && console.log(n),
            `<span class="katex-error" title="${escapeHtml(e)}">${escapeHtml(
              n + ""
            )}</span>`
          );
        }
