...
!(function (e, t) {
                    ...
                    if ("list" !== h?.type);
                        ...
                        (r[r.length - 1] = l),
                            ...
                            (s =
                                ...
                                l.raw),
                            (e = i
                                .substring(r[r.length - 1].raw.length)
                                .split("\n"));
                    }
                }
    ...
    class te {
        ...
        inlineTokens(e, t = []) {
            ...
            for (
                ;
                null !=
                (i = this.tokenizer.rules.inline.anyPunctuation.exec(a));
            ...
            return (
                e.forEach((e) => {
                    ...
                    if (
                        ...
                        const t =
                            this.defaults.renderer || new ne(this.defaults);
                        ...
                        return s.type && s.type === t
                            ? e.call(
                                  ...
                                  (function (e) {
                                      ...
                                      n.parser.parseInline(
                                          s.tokens,
                                          n.parser.textRenderer
                                      )
                                  )
                              )
            ...
            return (n, s) => {
                ...
                if ((i.hooks && (i.hooks.options = i), i.async))
                    return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
                        .then((t) => e(t, i))
                        .then((e) =>
                            i.hooks ? i.hooks.processAllTokens(e) : e
                        )
                        .then((e) =>
                            i.walkTokens
                                ? Promise.all(
    ...
    (ae.options = ae.setOptions =
        ...
        (ae.use = function (...e) {
            return (
                oe.use(...e), (ae.defaults = oe.defaults), n(ae.defaults), ae
            );
        }),
