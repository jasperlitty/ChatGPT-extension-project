  ...
  return (function () {
    ...
    var Ve = {
      ...
      staticSvg: function (e, t) {
        const [r, n, o] = De[e],
          ...
          a = He(["overlay"], [i], t);
        return (
          (a.height = o), (a.style.height = F(o)), (a.style.width = F(n)), a
        );
      },
      svgData: De,
      tryCombineChars: (e) => {
          ...
          ot(
            ...
            (e, t) => {
              const r = at(t),
                n = at(e),
                o =
                  r && n ? (e.hasClass("mtight") ? Ye[r][n] : Ue[r][n]) : null;
    ...
    const Zt = function (e, t, r) {
      ...
      Kt = function (e, t, r, n) {
        ...
        return (
          (s.height *= i), (s.depth *= i), (s.maxFontSize = o.sizeMultiplier), s
        );
      },
      Jt = function (e, t, r) {
        ...
        htmlBuilder: (e, t) => {
          ...
          if (
            ...
            (n =
              "." === e.left
                ? lt(t, ["mopen"])
                : yr.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"])),
            r.unshift(n),
            a)
          )
    ...
    Ar({
      ...
      props: { numArgs: 1 },
      handler(e, t) {
        const r = (Rt(t[0]) ? [t[0]] : qt(t[0], "ordgroup").body).map(function (
            e
          ) {
            const t = It(e).text;
    ...
    const Jr = (e, t, r, n, o, s, i) => {
      ...
      en = (e, t) => {
        let r,
          ...
          s = !1;
        "supsub" === e.type
          ? ((r = e.sup), (n = e.sub), (o = qt(e.base, "op")), (s = !0))
          : (o = qt(e, "op"));
        const i = t.style;
        let a,
          h = !1;
      ...
      tn = (e, t) => {
        ...
        if (e.symbol)
          (r = new ut("mo", [ft(e.name, e.mode)])),
            l.contains(Qr, e.name) && r.setAttribute("largeop", "false");
    ...
    je({
      ...
      je({
        ...
        mathmlBuilder: (e, t) => {
          ...
          return (
            o.setAttribute("height", "0px"), o.setAttribute("depth", "0px"), o
          );
        },
      }),
      je({
      ...
      je({
        ...
        htmlBuilder(e, t) {
          ...
          for (let t = 0; t < r.length; t++) {
            ...
            "~" === s && (s = "\\textasciitilde"),
              n.push(
                Ve.makeSymbol(s, "Typewriter-Regular", e.mode, o, [
                  "mord",
                  "texttt",
                ])
              );
    ...
    Br("\\newcommand", (e) => Bn(e, !1, !0)),
      ...
      Br("\\show", (e) => {
        const t = e.popToken(),
          r = t.text;
        return (
          console.log(t, e.macros.get(r), yn[r], oe.math[r], oe.text[r]), ""
        );
      }),
      Br("\\bgroup", "{"),
      Br("\\egroup", "}"),
    ...
    Br("\\dots", function (e) {
      ...
      return (
        r in Cn
          ? (t = Cn[r])
          : ("\\not" === r.slice(0, 4) ||
              (r in oe.math && l.contains(["bin", "rel"], oe.math[r].group))) &&
            (t = "\\dotsb"),
        t
      );
    });
