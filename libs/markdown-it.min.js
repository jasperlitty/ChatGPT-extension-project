...
!(function (t, e) {
    ...
    (i.prototype.parse = function (t, e) {
        ...
        if (((i = i.trim()), !e && 1 === t.split("#").length)) {
            ...
            if (t)
                return (
                    (this.pathname = t[1]), t[2] && (this.search = t[2]), this
                );
        }
        let u = o.exec(i);
        if (
    ...
    function M(t) {
        return (
            (t >= S.UPPER_A && t <= S.UPPER_F) ||
            (t >= S.LOWER_A && t <= S.LOWER_F)
        );
    }
    function T(t) {
        return (
    ...
    const W = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
        J = new RegExp(
            W.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source,
            "gi"
        ),
    ...
    var ht = Object.freeze({
        ...
        parseLinkLabel: function (t, e, r) {
            ...
            for (t.pos = e + 1, n = 1; t.pos < u; ) {
                if (
                    ((i = t.src.charCodeAt(t.pos)), 93 === i && (n--, 0 === n))
                ) {
                    s = !0;
                    break;
                }
    ...
    (pt.code_inline = function (t, e, r, n, s) {
        ...
        (pt.fence = function (t, e, r, n, s) {
            ...
            if (
                ((u =
                    (r.highlight && r.highlight(i.content, c, a)) ||
                    rt(i.content)),
                0 === u.indexOf("<pre"))
            )
                return u + "\n";
            ...
            return (
                t.forEach(function (t) {
                    ...
                    if (n < 0) {
                        if (e) return;
                        throw new Error(
                            "Rules manager: invalid rule name " + t
                        );
                    }
            ...
            t: for (; c < a; ) {
                ...
                if (l.index - 1 >= 0) d = u.charCodeAt(l.index - 1);
                    ...
                    for (
                        ...
                        if (t[r].content) {
                            d = t[r].content.charCodeAt(
                                t[r].content.length - 1
                            );
                            break;
                        }
                let _ = 32;
            ...
            function (t) {
                ...
                if (t.md.options.linkify)
                    for (let n = 0, s = e.length; n < s; n++) {
                        if (
                            "inline" !== e[n].type ||
                            !t.md.linkify.pretest(e[n].content)
                        )
                            continue;
                        let s = e[n].children,
                            i = 0;
                ...
                if (t.md.options.typographer)
                    for (e = t.tokens.length - 1; e >= 0; e--)
                        "inline" === t.tokens[e].type &&
                            (yt.test(t.tokens[e].content) &&
                                Ft(t.tokens[e].children),
                            Ct.test(t.tokens[e].content) &&
                                xt(t.tokens[e].children));
            },
        ],
        [
            "smartquotes",
    ...
    const Ut = [
        ...
        [
            ...
            function (t, e, r, n) {
                ...
                const a = t.src.slice(u, s),
                    l = t.src.slice(s, i);
                if (96 === o && l.indexOf(String.fromCharCode(o)) >= 0)
                    return !1;
                if (n) return !0;
                let h = e,
                    p = !1;
        ...
        [
            ...
            function (t, e, r, n) {
                ...
                c > s && st(t.src.charCodeAt(c - 1)) && (i = c),
                    (t.line = e + 1);
    ...
    function se(t) {
        ...
        for (let o = 0; o < r; o++) {
            ...
            if (
                ...
                continue;
            e.hasOwnProperty(r.marker) ||
                (e[r.marker] = [-1, -1, -1, -1, -1, -1]);
            ...
            -1 !== a &&
                (e[r.marker][(r.open ? 3 : 0) + ((r.length || 0) % 3)] = a);
        }
    }
    const ie = [
            [
                ...
                function (t, e) {
                    ...
                    return (
                        r !== t.pos &&
                        (e || (t.pending += t.src.slice(t.pos, r)),
                        (t.pos = r),
                        !0)
                    );
                },
            ...
            [
                ...
                function (t, e) {
                    ...
                    if (!n) return !1;
                    const s = n[1],
                        i = t.md.linkify.matchAtStart(
                            t.src.slice(r - s.length)
                        );
                    if (!i) return !1;
                    let o = i.url;
            ...
            [
                ...
                function (t, e) {
                    ...
                    for (; -1 !== (u = t.src.indexOf("`", c)); ) {
                        for (c = u + 1; c < s && 96 === t.src.charCodeAt(c); )
                            c++;
                        const n = c - u;
                        if (n === o) {
                            if (!e) {
                ...
                function (t, e) {
                    ...
                    if (d < h && 40 === t.src.charCodeAt(d)) {
                        for (
                            a = !1, d++;
                            d < h &&
                            ((r = t.src.charCodeAt(d)), st(r) || 10 === r);
                            d++
                        );
                        if (d >= h) return !1;
                        if (
                            ((c = d),
                            (s = t.md.helpers.parseLinkDestination(
                                t.src,
                                d,
                                t.posMax
                            )),
                ...
                function (t, e) {
                    ...
                    if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
                        for (
                            i++;
                            i < p &&
                            ((r = t.src.charCodeAt(i)), st(r) || 10 === r);
                            i++
                        );
                        if (i >= p) return !1;
                        for (
                            a = i,
                                u = t.md.helpers.parseLinkDestination(
                                    t.src,
                                    i,
                                    t.posMax
                                ),
    ...
    function ue() {
        ...
        for (let t = 0; t < oe.length; t++)
            this.ruler2.push(oe[t][0], oe[t][1]);
    }
    function ce(t) {
        return (
            Array.prototype.slice.call(arguments, 1).forEach(function (e) {
    ...
    function me(t) {
        ...
        (t.re.schema_test = RegExp(
            ...
            (t.re.schema_at_start = RegExp(
                "^" + t.re.schema_search.source,
                "i"
            )),
            (t.re.pretest = RegExp(
                "(" +
    ...
    const qe = function (t, e) {
        ...
        Le = function (t) {
            ...
            o < 0 && (o = 0);
            for (let r = 0; r < o; ++r)
                t.charCodeAt(r) >= 128 && ve("not-basic"),
