            ...
            (function () {
                ...
                var a = function (e, t) {
                    ...
                    for (; (r = e.search(a)), -1 !== r; ) {
                        r > 0 &&
                            (o.push({ type: "text", data: e.slice(0, r) }),
                            (e = e.slice(r)));
                        const a = t.findIndex((t) => e.startsWith(t.left));
                        if (
                            ((r = n(t[a].right, e, t[a].left.length)), -1 === r)
                        )
                            break;
                ...
                const l = function (e, n) {
                        ...
                        for (let e = 0; e < r.length; e++)
                            if ("text" === r[e].type)
                                o.appendChild(
                                    document.createTextNode(r[e].data)
                                );
                            else {
                        ...
                        for (let n = 0; n < e.childNodes.length; n++) {
                            ...
                            if (3 === r.nodeType) {
                                ...
                                if (s) {
                                    ...
                                    (n += s.childNodes.length - 1),
                                        e.replaceChild(s, r);
                                } else n += a;
                            } else if (1 === r.nodeType) {
                                const e = " " + r.className + " ";
                                -1 ===
                                    t.ignoredTags.indexOf(
